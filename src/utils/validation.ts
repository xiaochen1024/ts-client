export function isIdentity(value: string = '') {
  let ret = false
  const idCard = value
...
export function isStrEN(value: string) {
...
export function isNumAlp(value: string) {
